 ...
 *
 * We avoid `import type` from 'mapbox-gl' to keep Vite's tree-shaker from
 * trying to also resolve the runtime entry. Types here are intentionally loose
 * (`any` for the heavy surface area) — Phase 2+ can tighten them per call site.
 */
export {};
