...
|---|-------|-------------|--------|----------|---------|----------|
| 0 | Repo scaffold | pnpm workspaces, TS config, package boundaries, build pipeline, VS Code extension shell | pending | - | - | [phase-0-repo-scaffold.plan.md](../plans/phase-0-repo-scaffold.plan.md) |
| 1 | MVP — Single-file viewer | Right-click command + webview + Mapbox + basemap toggle + hover popup + BYO token | pending | - | 0 | [phase-1-mvp-single-file-viewer.plan.md](../plans/phase-1-mvp-single-file-viewer.plan.md) |
